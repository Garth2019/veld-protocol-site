  ...
  return (
    <section className="min-h-[calc(100vh-4rem)] px-4 sm:px-6 lg:px-8 py-16 sm:py-24 max-w-4xl mx-auto">
      ...
      <a
        ...
        className="mt-8 inline-flex items-center gap-2 rounded-md border border-white/10 px-4 py-2.5 text-sm text-veld-pale/70 transition-colors hover:text-veld-pale hover:bg-white/5"
      >
