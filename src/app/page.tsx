...
export default function Home() {
  return (
    <section className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight text-veld-light text-center">
        Veld Protocol
      </h1>
      ...
      <a
        ...
        className="mt-6 inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm text-veld-pale/50 transition-colors hover:text-veld-pale hover:bg-white/5"
      >
